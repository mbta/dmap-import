...
class DeviceEvents(SqlBase):
    ...
    event_type_id = sa.Column(sa.Integer, nullable=True)
    ...
    clear_message_id = sa.Column(sa.Integer, nullable=True)
    ...
    component_serial_nbr = sa.Column(sa.Integer, nullable=True)

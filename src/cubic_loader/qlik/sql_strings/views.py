...
SELECT
  ...
  (CSR_PATRON_ORDER_DETAIL.ORDER_TOTAL_PRODUCT_VALUE)::numeric / 100 AS ORDER_TOTAL_PRODUCT_VALUE,
  (CSR_PATRON_ORDER_DETAIL.ORDER_TOTAL_FEES_VALUE)::numeric / 100 AS ORDER_TOTAL_FEES_VALUE,
  CSR_PATRON_ORDER_DETAIL.ORDER_TOTAL_DEPOSIT_VALUE::numeric / 100 AS ORDER_TOTAL_DEPOSIT_VALUE,
  (CSR_PATRON_ORDER_DETAIL.ORDER_TOTAL_VALUE)::numeric / 100 AS ORDER_TOTAL_VALUE,
...
END AS LINE_ITEM_TYPE,
  ...
  (CSR_PATRON_ORDER_DETAIL.DEPOSIT_VALUE)::numeric / 100 AS DEPOSIT_VALUE,
  (CSR_PATRON_ORDER_DETAIL.REPLACEMENT_FEE)::numeric / 100 AS REPLACEMENT_FEE,
  (CSR_PATRON_ORDER_DETAIL.ADMINISTRATIVE_FEE)::numeric / 100 AS ADMINISTRATIVE_FEE,
  (CSR_PATRON_ORDER_DETAIL.LINE_ITEM_TOTAL_VALUE)::numeric / 100 AS LINE_ITEM_TOTAL_VALUE,
  CSR_PATRON_ORDER_DETAIL.LINE_ITEM_STATUS,
  CSR_PATRON_ORDER_DETAIL.LINE_ITEM_SEQUENCE,
  CSR_PATRON_ORDER_DETAIL.LINE_ITEM_SHIPPING_FEE::numeric/100 AS LINE_ITEM_SHIPPING_FEE,
  ...
  CSR_PATRON_ORDER_DETAIL.LINE_ITEM_CARD_FEE::numeric/100 AS LINE_ITEM_CARD_FEE,
  CSR_PATRON_ORDER_DETAIL.LINE_ITEM_ENABLEMENT_FEE::numeric/100 AS LINE_ITEM_ENABLEMENT_FEE,
  CSR_PATRON_ORDER_DETAIL.LINE_ITEM_REPLACEMENT_FEE::numeric/100 AS LINE_ITEM_REPLACEMENT_FEE,
  CSR_PATRON_ORDER_DETAIL.PG_CARD_ID,
  CSR_PATRON_ORDER_DETAIL.RIDER_CLASS_NAME,
  COALESCE(CSR_PATRON_ORDER_DETAIL.DISCOUNT_AMOUNT::numeric/100,0) AS DISCOUNT_AMOUNT,
  ...
  COALESCE(CSR_PATRON_ORDER_DETAIL.REFUND_FEE::numeric/100,0) AS REFUND_FEE,
  ...
  COALESCE(CSR_PATRON_ORDER_DETAIL.LINE_ITEM_ONE_ACCOUNT_VALUE,0)::numeric/100 AS LINE_ITEM_ONE_ACCOUNT_VALUE,
  COALESCE(CSR_PATRON_ORDER_DETAIL.line_item_rounding_amount::numeric/100,0) AS line_item_rounding_amount,

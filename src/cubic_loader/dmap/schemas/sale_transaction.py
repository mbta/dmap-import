...
class SaleTransaction(SqlBase):
    ...
    customer_postal_code = sa.Column(sa.String(), nullable=True)
    ...
    count_as_sale = sa.Column(sa.BigInteger, nullable=True)
    ...
    external_account_id = sa.Column(sa.String(), nullable=True)
    ...
    amount_short = sa.Column(sa.BigInteger, nullable=True)
    benefit_amount_used = sa.Column(sa.BigInteger, nullable=True)
    bonus_value = sa.Column(sa.BigInteger, nullable=True)
    value_changed = sa.Column(sa.BigInteger, nullable=True)
    value_remaining = sa.Column(sa.BigInteger, nullable=True)
    cash_collected = sa.Column(sa.BigInteger, nullable=True)
    device_id = sa.Column(sa.String(), nullable=True)
    device_position = sa.Column(sa.BigInteger, nullable=True)
    external_stop_point_id = sa.Column(sa.String(), nullable=True)
    facility_id = sa.Column(sa.BigInteger, nullable=True)
    fare_collected = sa.Column(sa.BigInteger, nullable=True)
    ...
    merchant_id = sa.Column(sa.String(), nullable=True)
    ...
    over_payment = sa.Column(sa.BigInteger, nullable=True)
    over_payment_credit = sa.Column(sa.BigInteger, nullable=True)
    ...
    serial_nbr = sa.Column(sa.String(), nullable=True)
